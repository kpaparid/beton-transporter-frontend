...
export default () => {
    ...
    function clearData() {
        setMessage({ id: 0, from: "", to: "", title: "", mail: "", date: "", status: "" });
        setVisible(0);
        setReceivers([])
    }
    const data = { visible, setVisible, message, setMessage, receivers, setReceivers, clearData }
            ...
            <div className="py-4 d-flex flex-wrap">
                <div className="container-fluid p-0">
                    <div className="row">
                        ...
                        <div className={`col-12 col-sm-6 p-1 ${visible === 1 ? "d-flex" : "d-none"}`}>
                            <NewMessage
                                data={data}
                                table={teamMembers}
                            />
                        </div>
                        <div className={`col-12 col-sm-6 p-1 ${visible === 2 ? "d-flex" : "d-none"}`}>
                            <DisplayMessage
                                data={data}
                            />
                        </div>
