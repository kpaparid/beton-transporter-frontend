...
export const TransactionsTable = (props) => {
  ...
  const TableRow = (props) => {
    const { status } = props;
    const { datum, wagen, werk, cbm, abfahrt, kmAbfahrt, ankunft, kmAnkunft, lieferscheinNr, fahrer, baustelle, entladeBeginn, entladeEnde, entladeTyp, wartezeit, sonstiges } = props;
    ...
    return (
      <tr className="text-center">
        ...
        {/* <MyTextArea text={datum} editMode={editMode}/> */}
        </td>
        <td>
        </td>
        <td>
        ...
        <Table hover className="user-table align-items-center">
          <thead className="thead-light">
            <tr>
              ...
              <th className="border-bottom">Wagen</th>
              <th className="border-bottom">Werk</th>
              <th className="border-bottom">Cbm</th>
              <th className="border-bottom">Abfahrt</th>
              <th className="border-bottom">Km Stand bei Abfahrt</th>
              <th className="border-bottom">Ankunft</th>
              <th className="border-bottom">Km Stand bei Ankunft</th>
              <th className="border-bottom">Lieferschein Nr.</th>
              <th className="border-bottom">Fahrer</th>
              <th className="border-bottom">Baustelle</th>
              <th className="border-bottom">Entladebeginn</th>
              <th className="border-bottom">Entladeende</th>
              <th className="border-bottom">Entladetyp</th>
              <th className="border-bottom">Wartezeit</th>
              <th className="border-bottom">Sonstiges</th>
            </tr>
            
          </thead>
          <tbody>
            {transactions.map(t => <TableRow key={`transaction-${t.id}`} {...t} />)}
          </tbody>
        </Table>
