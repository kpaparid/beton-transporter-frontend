        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              <NavItem title="React Project" link={Routes.Presentation.path} image={ReactHero} />

              <NavItem title="Overview" link={Routes.DashboardOverview.path} icon={faChartPie} />
              <NavItem title="Touren" icon={faHandHoldingUsd} link={Routes.Transactions.path} />
              <NavItem title="Arbeitszeiten" icon={faHandHoldingUsd} link={Routes.Arbeitszeiten.path} />
              <NavItem title="Nachrichten" icon={faHandHoldingUsd} link={Routes.Nachrichten.path} />
